...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-2xl mx-auto">
        <h1 class="text-3xl font-bold text-gray-800 mb-6">Tambah Lokasi Baru</h1>
        
        <form action="{{ route('admin.locations.store') }}" method="POST" class="bg-white rounded-lg shadow-md p-6">
            @csrf
